...
module MultiHeadedQueue_1(	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7]
  ...
  wire [2:0]       _raddr_T_11 = 3'h7 - raddr;	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:23:22, generators/gemmini/src/main/scala/gemmini/Util.scala:13:57]
  ...
  wire [2:0]       _io_deq_bits_1_T_19 = (&raddr) ? 3'h1 - _raddr_T_11 - 3'h1 : raddr + 3'h1;	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:23:22, generators/gemmini/src/main/scala/gemmini/Util.scala:13:{10,13,48,57,62,71}]
  wire [2:0]       _io_deq_bits_2_T_19 = raddr > 3'h5 ? 3'h2 - _raddr_T_11 - 3'h1 : raddr + 3'h2;	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:23:22, generators/gemmini/src/main/scala/gemmini/Util.scala:13:{10,13,48,57,62,71}]
  wire [3:0]       _GEN_4 = {2'h0, io_deq_pop};	// @[generators/gemmini/src/main/scala/gemmini/Util.scala:13:22]
  ...
  `endif // not def SYNTHESIS
  wire [2:0]       _GEN_5 = {1'h0, io_deq_pop};	// @[generators/gemmini/src/main/scala/gemmini/Util.scala:13:22]
  wire             _len_T_4 = ~(len[3]) & io_enq_valid;	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:25:20, :27:23, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  always @(posedge clock) begin	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7]
    if (_len_T_4 & waddr == 3'h0) begin	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:22:17, :24:22, :36:22, :37:17, src/main/scala/chisel3/util/Decoupled.scala:51:35]
    ...
    if (_len_T_4 & waddr == 3'h1) begin	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:22:17, :24:22, :36:22, :37:17, src/main/scala/chisel3/util/Decoupled.scala:51:35]
    ...
    if (_len_T_4 & waddr == 3'h2) begin	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:22:17, :24:22, :36:22, :37:17, src/main/scala/chisel3/util/Decoupled.scala:51:35]
    ...
    if (_len_T_4 & waddr == 3'h3) begin	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:22:17, :24:22, :36:22, :37:17, src/main/scala/chisel3/util/Decoupled.scala:51:35]
    ...
    if (_len_T_4 & waddr == 3'h4) begin	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:22:17, :24:22, :36:22, :37:17, src/main/scala/chisel3/util/Decoupled.scala:51:35]
    ...
    if (_len_T_4 & waddr == 3'h5) begin	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:22:17, :24:22, :36:22, :37:17, src/main/scala/chisel3/util/Decoupled.scala:51:35]
    ...
    if (_len_T_4 & waddr == 3'h6) begin	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:22:17, :24:22, :36:22, :37:17, src/main/scala/chisel3/util/Decoupled.scala:51:35]
    ...
    if (reset) begin	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7]
      ...
      waddr <= 3'h0;	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:24:22]
      ...
      if (|io_deq_pop) begin	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:43:19]
        raddr <= raddr >= 3'h7 - _GEN_5 + 3'h1 & (|io_deq_pop) ? _GEN_5 - _raddr_T_11 - 3'h1 : raddr + _GEN_5;	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:23:22, generators/gemmini/src/main/scala/gemmini/Util.scala:13:{10,13,22,26,32,37,48,57,62,71}]
        len <= len - _GEN_4 + {3'h0, _len_T_4};	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:25:20, :45:{16,29}, generators/gemmini/src/main/scala/gemmini/Util.scala:13:22, src/main/scala/chisel3/util/Decoupled.scala:51:35]
      end
      else if (_len_T_4)	// @[src/main/scala/chisel3/util/Decoupled.scala:51:35]
        len <= len + 4'h1;	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:25:20, :39:16]
      if (_len_T_4)	// @[src/main/scala/chisel3/util/Decoupled.scala:51:35]
        waddr <= (&waddr) ? 3'h1 - (3'h7 - waddr) - 3'h1 : waddr + 3'h1;	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:24:22, generators/gemmini/src/main/scala/gemmini/Util.scala:13:{10,13,48,57,62,71}]
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7]
    ...
    logic [31:0] _RANDOM[0:68];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7]
    initial begin	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7]
        ...
        regs_0_rob_id_valid = _RANDOM[7'h8][9];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_0_rob_id_bits = _RANDOM[7'h8][15:10];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_1_cmd_inst_funct = _RANDOM[7'h8][24:18];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_1_cmd_rs1 = {_RANDOM[7'h9][31:18], _RANDOM[7'hA], _RANDOM[7'hB][17:0]};	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_1_cmd_rs2 = {_RANDOM[7'hB][31:18], _RANDOM[7'hC], _RANDOM[7'hD][17:0]};	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_1_rob_id_valid = _RANDOM[7'h10][27];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_1_rob_id_bits = {_RANDOM[7'h10][31:28], _RANDOM[7'h11][1:0]};	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_2_cmd_inst_funct = _RANDOM[7'h11][10:4];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_2_cmd_rs1 = {_RANDOM[7'h12][31:4], _RANDOM[7'h13], _RANDOM[7'h14][3:0]};	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_2_cmd_rs2 = {_RANDOM[7'h14][31:4], _RANDOM[7'h15], _RANDOM[7'h16][3:0]};	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_2_rob_id_valid = _RANDOM[7'h19][13];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_2_rob_id_bits = _RANDOM[7'h19][19:14];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_3_cmd_inst_funct = _RANDOM[7'h19][28:22];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_3_cmd_rs1 = {_RANDOM[7'h1A][31:22], _RANDOM[7'h1B], _RANDOM[7'h1C][21:0]};	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_3_cmd_rs2 = {_RANDOM[7'h1C][31:22], _RANDOM[7'h1D], _RANDOM[7'h1E][21:0]};	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_3_rob_id_valid = _RANDOM[7'h21][31];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_3_rob_id_bits = _RANDOM[7'h22][5:0];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_4_cmd_inst_funct = _RANDOM[7'h22][14:8];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_4_cmd_rs1 = {_RANDOM[7'h23][31:8], _RANDOM[7'h24], _RANDOM[7'h25][7:0]};	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_4_cmd_rs2 = {_RANDOM[7'h25][31:8], _RANDOM[7'h26], _RANDOM[7'h27][7:0]};	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_4_rob_id_valid = _RANDOM[7'h2A][17];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_4_rob_id_bits = _RANDOM[7'h2A][23:18];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_5_cmd_inst_funct = {_RANDOM[7'h2A][31:26], _RANDOM[7'h2B][0]};	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_5_cmd_rs1 = {_RANDOM[7'h2B][31:26], _RANDOM[7'h2C], _RANDOM[7'h2D][25:0]};	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_5_cmd_rs2 = {_RANDOM[7'h2D][31:26], _RANDOM[7'h2E], _RANDOM[7'h2F][25:0]};	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_5_rob_id_valid = _RANDOM[7'h33][3];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_5_rob_id_bits = _RANDOM[7'h33][9:4];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_6_cmd_inst_funct = _RANDOM[7'h33][18:12];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_6_cmd_rs1 = {_RANDOM[7'h34][31:12], _RANDOM[7'h35], _RANDOM[7'h36][11:0]};	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_6_cmd_rs2 = {_RANDOM[7'h36][31:12], _RANDOM[7'h37], _RANDOM[7'h38][11:0]};	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_6_rob_id_valid = _RANDOM[7'h3B][21];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_6_rob_id_bits = _RANDOM[7'h3B][27:22];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_7_cmd_inst_funct = {_RANDOM[7'h3B][31:30], _RANDOM[7'h3C][4:0]};	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_7_cmd_rs1 = {_RANDOM[7'h3C][31:30], _RANDOM[7'h3D], _RANDOM[7'h3E][29:0]};	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_7_cmd_rs2 = {_RANDOM[7'h3E][31:30], _RANDOM[7'h3F], _RANDOM[7'h40][29:0]};	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_7_rob_id_valid = _RANDOM[7'h44][7];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_7_rob_id_bits = _RANDOM[7'h44][13:8];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        raddr = _RANDOM[7'h44][18:16];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17, :23:22]
        waddr = _RANDOM[7'h44][21:19];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17, :24:22]
        len = _RANDOM[7'h44][25:22];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17, :25:20]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_enq_ready = ~(len[3]);	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :25:20, :27:23]
  assign io_deq_valid_0 = |len;	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :25:20, :31:28]
  assign io_deq_valid_1 = |(len[3:1]);	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :25:20, :31:28]
  assign io_deq_valid_2 = len > 4'h2;	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :25:20, :31:28]
